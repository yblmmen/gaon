...
<div id="bo_list" style="width:<?php echo $width; ?>">
    ...
    <nav id="bo_cate">
        <h2>
          <?php if($sca){echo $sca;}else{echo "카테고리";}?>
    ...
    <div class="tbl_head01 tbl_wrap">
        ...
        <tr>
            ...
            <th scope="col" class="mb_hide"><?php echo subject_sort_link('wr_hit', $qstr2, 1) ?>조회 </a></th>
            <?php if ($is_good) { ?><th scope="col" class="mb_hide"><?php echo subject_sort_link('wr_good', $qstr2, 1) ?>추천 </a></th><?php } ?>
            <?php if ($is_nogood) { ?><th scope="col" class="mb_hide"><?php echo subject_sort_link('wr_nogood', $qstr2, 1) ?>비추천 </a></th><?php } ?>
        ...
        <tr class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
            ...
            if ($list[$i]['is_notice']) // 공지사항
                echo '<strong class="notice_icon"><i class="fa fa-bullhorn" aria-hidden="true"></i></strong>';
            ...
            <td class="td_name sv_use mb_hide"><?php echo $list[$i]['name'] ?></td>
            <td class="td_num mb_hide"><?php echo $list[$i]['wr_hit'] ?></td>
            <?php if ($is_good) { ?><td class="td_num mb_hide"><?php echo $list[$i]['wr_good'] ?></td><?php } ?>
            <?php if ($is_nogood) { ?><td class="td_num mb_hide"><?php echo $list[$i]['wr_nogood'] ?></td><?php } ?>
