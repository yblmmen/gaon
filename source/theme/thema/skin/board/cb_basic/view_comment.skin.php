...
<button type="button" class="cmt_btn"><i class="fa fa-commenting-o" aria-hidden="true"></i> COMMENTS</button>
<?php }?>
<!-- 댓글 시작 { -->
<section id="bo_vc">
    <h2>댓글목록</h2>
    ...
    <?php } ?>
    <?php if ($i == 0) {  if($board['bo_comment_level'] <= $member['mb_level']){ //댓글이 없다면 ?>
