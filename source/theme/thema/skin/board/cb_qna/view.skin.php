    ...
    <header>
        <h4 id="bo_v_title">
			...
			<?php } else {?>
				...
				<span class="sound_only">답변</span><strong><a href="#bo_vc"> <i class="fa fa-commenting-o" aria-hidden="true"></i> <?php echo number_format($view['wr_comment']) ?>건의 답변이 등록 되었습니다.</a></strong>
				<?php } else {?>
