이해했습니다! 제가 지금까지 이 채팅에서 제공한 설명과 최종 메뉴얼을 Markdown 형식(README.md)으로 정리해서 출력하겠습니다. 이 파일은 GitHub 저장소에 업로드하여 보관하기에 적합하도록 작성되며, 최종적으로 MariaDB 버전을 11.3.2로 수정한 통합 YAML 파일과 전체 과정을 포함합니다.
